...
<head>
    ...
    <title>Admin Pannel - Venues</title>
...
<div class="modal fade" id="add-room" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" autocomplete="off">
...
<div class="modal fade" id="room-images" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <?php
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="" id="image-alert"></div>
         <div class="border-bottom border-3 pb-3 mb-3">
            <form id="add_image_form" action="ajax/rom.php" method="post" enctype="multipart/form-data">
            <label  class="form-label fw-bold">Add image</label>
              <input type="file" name="image"  accept=".jpg, .png, .jpeg" class="form-control shadow-none mb-3" required>
              <button name="save_stud_image" class="btn custom-bg text-white shadow-none">Add</button>
              <input type="hidden" name="room_id">
            </form>
         </div>
