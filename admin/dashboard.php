...
<body class="bg-light">
   <?php
    ...
    $current_bookings = mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(CASE WHEN `status`='success' AND
    arrival=0 THEN 1 END) AS `new_bookings`, 
    COUNT(CASE WHEN `status`='cancelled' AND refund=0 THEN 1 END) AS `refund_bookings` FROM `bookingorder`"));

    $unread_queries = mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(sr_no) AS `count` FROM `user_queries` WHERE `seen`=0"));

    $unread_request = mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(sr_no) AS `count` FROM `partner` WHERE `seen`=0"));
    ...
    COUNT(CASE WHEN `verify_status`=0 THEN 1 END) AS `unverified`
    FROM `users`"));
        ...
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3 mb-4">
                        <a href="partner.php" class="text-decoration-none">
                            <div class="card text-center text-info p-3">
                                <h6>Partnership Request</h6>
                                <h1 class="mt-2 mb-0"><?php echo $unread_request['count'] ?></h1>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-primary p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="total_amt">₹1</h4>
                        </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-success p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="active_amt">₹1</h4>
                        </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-danger p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="cancelled_amt">₹1</h4>
                        </div>
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h5>Querires, Review Analytics</h5>
